...
import { createSettlementBatch, getSettlementBatchDetails, listSettlementBatches, confirmBatchUSD, confirmBatchLYD, finalizeBatch, transitionStage, bulkTransitionStage, getTransactionStageHistory, getSettlementLedger, addTransactionToBatch, removeTransactionFromBatch, } from '../services/settlement-service.js';
const router = Router();
// ============================================
 ...
 */
router.post('/batch', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
 ...
 */
router.get('/batches', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
 ...
 */
router.get('/batches/:id', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
 ...
 */
router.post('/batches/:id/add', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
 ...
 */
router.post('/batches/:id/remove', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
        const { transaction_id } = req.body;
 ...
 */
router.put('/stage/:transactionId', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
 ...
 */
router.put('/stage-bulk', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
 ...
 */
router.get('/history/:transactionId', verifyAuth, (req, res) => {
    try {
        const transactionId = parseInt(req.params.transactionId, 10);
 ...
 */
router.post('/batches/:id/confirm-usd', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
 ...
 */
router.post('/batches/:id/confirm-lyd', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
        const { transaction_ids } = req.body;
        const userId = req.user?.id || 0;
 ...
 */
router.post('/batches/:id/finalize', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
        const userId = req.user?.id || 0;
 ...
 */
router.get('/batches/:id/ledger', verifyAuth, requireRole('bank_admin'), (req, res) => {
    try {
        const batchId = parseInt(req.params.id, 10);
